...
class Rating_model():
    ...
    def fit(self, model_name, x_train, y_train, cv, search_cfg):
        if self.x_s == None:
        ...
        clf = self.MODEL_NAME[model_name](**random_clf.best_params_)
    ...
    def eval(self, model_name ,x_test, y_test, thresholds=[0.5]):
